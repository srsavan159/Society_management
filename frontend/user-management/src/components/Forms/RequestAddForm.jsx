...
const RequestAddForm = ({ onClose, onAdd }) => {
    ...
    return (
        <div className='w-full'>
            <h2 className="text-xl font-semibold border-b-1 border-b pb-2 mb-4">
                Create Request
            </h2>
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    <label className="block font-medium mb-1" htmlFor="requesterName">
                ...
                <div className="mb-4">
                    <label className="block font-medium mb-1" htmlFor="requestName">
