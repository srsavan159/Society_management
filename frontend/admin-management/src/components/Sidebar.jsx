  ...
  return (
    ...
    >
      <div className="flex justify-center items-center h-16 border-b p-4 gap-5">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-[#E74C3C] to-[#FFD351] bg-clip-text text-transparent mx-5 ">
      ...
      <div>
        <ul className="space-y-2 m-6">
          <li>
            <Link
              to="/"
              className={`flex items-center space-x-2 p-2 rounded-lg ${isActive('/') ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
              onClick={() => {
          ...
          <li>
            <Link
              ...
              className={`flex items-center space-x-2 p-2 rounded-lg ${isActive('/resident-management') ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
              onClick={() => {
                closeFinancialDropdown();
                closeCompiantDropdown();
                closeSecurityDropdown();
          ...
          <li>
            <button
              ...
              className={`w-full flex justify-between items-center p-2 rounded-lg ${isActive('/financial-management') || financialDropdownOpen ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
            >
          ...
          <li>
            <Link
              ...
              className={`flex items-center space-x-2 p-2 rounded-lg ${isActive('/facility-management') ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
              onClick={() => {
                closeFinancialDropdown();
                closeCompiantDropdown();
                closeSecurityDropdown();
          ...
          <li>
            <button
              ...
              className={`w-full flex justify-between items-center p-2 rounded-lg ${isActive('/complaint-tracking') || ComplaintDropdownOpen ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
            >
              <div className="flex items-center space-x-2">
          ...
          <li>
            <button
              ...
              className={`w-full flex justify-between items-center p-2 rounded-lg ${isActive('/security-management') || SecurityDropdownOpen ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
            >
              <div className="flex items-center space-x-2">
              <FaShieldAlt size={20} />
          ...
          <li>
            <Link
              to="/security-guard"
              className={`flex items-center space-x-2 p-2 rounded-lg ${isActive('/security-guard') ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
              onClick={() => {
                closeFinancialDropdown();
                closeCompiantDropdown();
                closeSecurityDropdown();
          ...
          <li>
            <Link
              to="/announcement"
              className={`flex items-center space-x-2 p-2 rounded-lg ${isActive('/announcement') ? 'bg-gradient-to-r from-[#E74C3C] to-[#FFD351] text-white' : 'text-gray-700 hover:text-orange-500'}`}
              onClick={() => {
                closeFinancialDropdown();
                closeCompiantDropdown();
                closeSecurityDropdown();
      ...
      <div className="absolute bottom-0 w-full">
        <button className="flex items-center m-6 space-x-2 p-2 pr-4 rounded-l-full bg-transparent text-[#E74C3C]">
          <span className="bg-gradient-to-r from-[#E74C3C] to-[#FFD351] p-2 rounded-full text-white">
            <FiLogOut size={20} />
          </span>
          <span>Logout</span>
        </button>
